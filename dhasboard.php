                    ...
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
							...
							<li class="nav-item dropdown  header-profile">
								<a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
									<img src="admin/images/user.jpg" width="56" alt="">
								</a>
								<div class="dropdown-menu dropdown-menu-end">
									...
									<a href="admin/email-inbox.html" class="dropdown-item ai-icon">
										<svg id="icon-inbox" xmlns="http://www.w3.org/2000/svg" class="text-success" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
										<span class="ms-2">Inbox </span>
									</a>
									<a href="admin/page-error-404.html" class="dropdown-item ai-icon">
				...
				<ul class="metismenu" id="menu">
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							<li><a href="admin/index.html">Dashboard Light</a></li>
							<li><a href="admin/index-2.html">Dashboard Dark</a></li>
							<li><a href="admin/project-page.html">Project</a></li>
							<li><a href="admin/contacts.html">Contacts</a></li>
							<li><a href="admin/kanban.html">Kanban</a></li>
							<li><a href="admin/calendar-page.html">Calendar</a></li>
							<li><a href="admin/message.html">Messages</a></li>	
						</ul>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
							...
							<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">Shop</a>
                                <ul aria-expanded="false">
                                    <li><a href="admin/ecom-product-grid.html">Product Grid</a></li>
									<li><a href="admin/ecom-product-list.html">Product List</a></li>
									<li><a href="admin/ecom-product-detail.html">Product Details</a></li>
									<li><a href="admin/ecom-product-order.html">Order</a></li>
									<li><a href="admin/ecom-checkout.html">Checkout</a></li>
									<li><a href="admin/ecom-invoice.html">Invoice</a></li>
									<li><a href="admin/ecom-customers.html">Customers</a></li>
                                </ul>
                            </li>
                        </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="admin/chart-chartjs.html">Chartjs</a></li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="admin/ui-grid.html">Grid</a></li>
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="admin/uc-select2.html">Select 2</a></li>
                            <li><a href="admin/uc-nestable.html">Nestedable</a></li>
                            ...
                            <li><a href="admin/map-jqvmap.html">Jqv Map</a></li>
							<li><a href="admin/uc-lightgallery.html">Light Gallery</a></li>
                        </ul>
                    </li>
                    <li><a href="admin/widget-basic.html" class="" aria-expanded="false">
                    ...
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="admin/table-bootstrap-basic.html">Bootstrap</a></li>
                            <li><a href="admin/table-datatable-basic.html">Datatable</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="admin/page-lock-screen.html">Lock Screen</a></li>
                            <li><a href="admin/empty-page.html">Empty Page</a></li>
                        </ul>
                    </li>
                </ul>
										...
										<div class="card">
											...
											<div class="card-body px-0">
												...
												<div class="d-flex justify-content-between recent-emails">
													<div class="d-flex">
														<div class="profile-k">
															<img src="admin/images/profile/small/pic6.jpg" alt="">
														</div>
														<div class="ms-3">
												...
												<div class="d-flex justify-content-between recent-emails">
													<div class="d-flex">
														<div class="profile-k">
															<img src="admin/images/profile/small/pic8.jpg" alt="">
														</div>
														<div class="ms-3">
															<h4 class="fs-18 font-w500">How to improve project management flows</h4>
															<span class="font-w400 d-block">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do<br> eiusmod tempor incididunt ut labore et dolore magna aliqua...</span>
													...
													<div class="card-body pb-0">
														<div class="project-details"> 
															<div class="d-flex align-items-center justify-content-between">
																<div class="d-flex align-items-center">
																	<span class="big-wind">
																		<img src="admin/images/big-wind.png" alt="">
																	</span>
																	<div class="ms-3">
																		<h4>Big Wind</h4>
														...
														<div class="project-details"> 
															<div class="d-flex align-items-center justify-content-between">
																<div class="d-flex align-items-center">
																	<span class="big-wind">
																		<img src="admin/images/circle-hunt.png" alt="">
																	</span>
																	<div class="ms-3">
																		<h4>Circle Hunt</h4>
																		<span class="fs-14 font-w400">Creative Agency</span>
										...
										<div class="card">
											...
											<div class="card-body px-0">
												...
												<div class="msg-bx d-flex justify-content-between align-items-center">
													<div class="msg d-flex align-items-center w-100">
														<div class="image-box">
															<img src="admin/images/profile/small/pic7.jpg" alt="">
														</div>	
														<div class="ms-3 w-100">
												...
												<div class="msg-bx d-flex justify-content-between align-items-center">
													<div class="msg d-flex align-items-center w-100">
														<div class="image-box active">
															<img src="admin/images/profile/small/pic4.jpg" alt="">
														</div>	
														<div class="ms-3 w-100">
												...
												<div class="msg-bx d-flex justify-content-between align-items-center">
													<div class="msg d-flex align-items-center w-100">
														<div class="image-box active">
															<img src="admin/images/profile/small/pic3.jpg" alt="">
														</div>	
														<div class="ms-3 w-100">
												...
												<div class="msg-bx d-flex justify-content-between align-items-center">
													<div class="msg d-flex align-items-center w-100">
														<div class="image-box active">
															<img src="admin/images/profile/small/pic5.jpg" alt="">
														</div>	
														<div class="ms-3 w-100">
